 ...
 *   by hook according to LibraryDefaultSkinVersionForNewAccounts. See Hooks and skin.json. The user
 *   may then change the preference at will.
 *
 * - Site configuration default. The default is controlled by LibraryDefaultSkinVersion and
 *   LibraryDefaultSkinVersionForExistingAccounts based on login state. The former is used
