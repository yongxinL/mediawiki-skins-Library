...
namespace Library\FeatureManagement\Requirements;

use Library\Constants;
use Library\FeatureManagement\Requirement;
use Library\SkinVersionLookup;
 ...
 *   to the `LibraryDefaultSkinVersionForNewAccounts` and
 *  `LibraryDefaultSkinVersionForExistingAccounts` config values. See the `Library\Hooks` class and
 *  `skin.json`.
 *
 ...
 *
 * - Site configuration default. The default is controlled by the `LibraryDefaultSkinVersion` config
 *   value. This is used for anonymous users and as a fallback configuration. See `skin.json`.
 *
 * This majority of this class is taken from Stephen Niedzielski's `Library\SkinVersionLookup` class,
 * which was introduced in `d1072d0fdfb1`.
 *
 * @unstable
 *
 * @package Library\FeatureManagement\Requirements
 * @internal
 */
